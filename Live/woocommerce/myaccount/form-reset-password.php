...
<form method="post" class="woocommerce-ResetPassword lost_reset_password ResetPassword">
	
	<div>
		<b><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce' ) ); ?>
		</b>
	...
	<div class="button-block">
		...
		<button type="submit" class="btn btn-primary  m-auto btn-large<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
	</div>
